    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_unit_dollar', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Prix unitaire en dollar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('food_category', models.CharField(choices=[('Viande', 'Viande'), ('Poisson', 'Poisson'), ('Légumes', 'Légumes'), ('Blabla', 'Blabla')], max_length=20, verbose_name='Catégorie de nourriture')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Tee-Shirt', 'Tee-Shirt'), ('Sweat-Shirt', 'Sweat-Shirt'), ('Cap', 'Cap')], max_length=20, verbose_name='Catégorie')),
                ('size', models.CharField(choices=[('XS', 'XS'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('XXL', 'XXL')], max_length=5, verbose_name='Taille')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trips', models.ManyToManyField(related_name='stocks', to='schedule.Trip', verbose_name='stock')),
            ],
            options={
                'verbose_name': 'Stock',
            },
